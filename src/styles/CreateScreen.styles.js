...
export const styles = StyleSheet.create({
  ...
  fabShare: { position: 'absolute', top: 130, // Adjust based on your header + scoreboard height
    right: 20, width: 40, height: 40, borderRadius: 20, backgroundColor: THEME.primary, justifyContent: 'center', alignItems: 'center', elevation: 5, shadowColor: THEME.primary, shadowOpacity: 0.5 },
});